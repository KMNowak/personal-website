...
Krzysztof (Chris) - specializing in scalable applications written in **TypeScript** with the use of **React** and **React Native** - both web and mobile. Additionally, proficient in creating backends for them in **Node.js**. Passionate about bringing ideas to life.
